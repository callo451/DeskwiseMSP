        ...
        <div className="space-y-6">
             <div className="flex items-center gap-4">
                <Button asChild variant="outline" size="icon">
                    <Link href="/change-management"><ChevronLeft className="h-4 w-4" /></Link>
                </Button>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex h-64 items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/30">
                        <p className="text-muted-foreground">The new change request form will be available here soon.</p>
                    </div>
                </CardContent>
            </Card>
        </div>
