...
import EnhancedReportsPage from './enhanced-page';
...
const MODULE_CONFIG = {
    Tickets: {
        columns: ['id', 'subject', 'client', 'assignee', 'priority', 'status', 'createdAt'],
        groupable: ['client', 'assignee', 'priority', 'status'],
        dateField: 'createdAt',
    },
    Assets: {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Comprehensive insights and custom reports for your MSP operations.
        </p>
      </div>

      <Tabs defaultValue="analytics" className="space-y-6">
        <TabsList>
          <TabsTrigger value="analytics">MSP Analytics</TabsTrigger>
