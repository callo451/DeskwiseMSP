...
// Mock tickets data removed - now using MongoDB database
...
// Ticket page stats now calculated from real database data via API
...
// Mock schedule items data removed - now using MongoDB database
